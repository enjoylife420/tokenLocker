...
var urlbsc = 'https://bsc-dataseed.binance.org/';
var web3_1 = __importDefault(require("web3"));
var ethereumMulticall = __importStar(require("../"));
var web3 = new web3_1.default(urlbsc);
var multicall = new ethereumMulticall.Multicall({
    web3Instance: web3,
    tryAggregate: true,
});
var TokenABI = [
...
function multicallFunctionWithError(contractAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var contractCallContext, multicallResults;
                ...
                case 0:
                    ...
                    contractCallContext.push({
                        ...
                        calls: [
                            ...
                            //   },
                            {
                                reference: 'tvl_pancake_farm_444',
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, multicallFunctionWithError('0x0000000000000000000000000000000000000064')];
                case 1:
                    // await multicallFunction('0x0000000000000000000000000000000000000064');
                    _a.sent();
                    return [2 /*return*/];
